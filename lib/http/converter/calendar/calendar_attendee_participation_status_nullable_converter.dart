...
class CalendarAttendeeParticipationStatusNullableConverter
    implements JsonConverter<CalendarAttendeeParticipationStatus?, String?> {
  const CalendarAttendeeParticipationStatusNullableConverter();

  @override
  CalendarAttendeeParticipationStatus? fromJson(String? json) =>
      json != null ? CalendarAttendeeParticipationStatus(json) : null;
