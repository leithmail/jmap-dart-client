...
Map<String, dynamic> _$RecurrenceRuleToJson(
  ...
  'interval': ?const RecurrenceRuleIntervalNullableConverter().toJson(
    instance.interval,
  ),
  'rscale': ?const RecurrenceRuleRScaleNullableConverter().toJson(
    instance.rscale,
  ),
  'skip': ?_$RecurrenceRuleSkipEnumMap[instance.skip],
  'firstDayOfWeek': ?_$DayOfWeekEnumMap[instance.firstDayOfWeek],
