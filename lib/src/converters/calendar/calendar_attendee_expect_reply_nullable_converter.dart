...
class CalendarAttendeeExpectReplyNullableConverter
    implements JsonConverter<CalendarAttendeeExpectReply?, bool?> {
  const CalendarAttendeeExpectReplyNullableConverter();

  @override
  CalendarAttendeeExpectReply? fromJson(bool? json) =>
      json != null ? CalendarAttendeeExpectReply(json) : null;
