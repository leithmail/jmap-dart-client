...
class CalendarSequenceNullableConverter
    implements JsonConverter<CalendarSequence?, int?> {
  const CalendarSequenceNullableConverter();

  @override
  CalendarSequence? fromJson(int? json) =>
      json != null ? CalendarSequence(json) : null;
