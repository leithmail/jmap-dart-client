...
class CalendarAttendeeExtensionFieldsNullableConverter
    implements JsonConverter<CalendarExtensionFields?, dynamic> {
  ...
  @override
  dynamic toJson(CalendarExtensionFields? object) =>
      object?.mapFields.toString();
}
