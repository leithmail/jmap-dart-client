...
class CalendarPriorityNullableConverter
    implements JsonConverter<CalendarPriority?, int?> {
  const CalendarPriorityNullableConverter();

  @override
  CalendarPriority? fromJson(int? json) =>
      json != null ? CalendarPriority(json) : null;
