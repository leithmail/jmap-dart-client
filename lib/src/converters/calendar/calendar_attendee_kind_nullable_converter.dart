...
class CalendarAttendeeKindNullableConverter
    implements JsonConverter<CalendarAttendeeKind?, String?> {
  const CalendarAttendeeKindNullableConverter();

  @override
  CalendarAttendeeKind? fromJson(String? json) =>
      json != null ? CalendarAttendeeKind(json) : null;
