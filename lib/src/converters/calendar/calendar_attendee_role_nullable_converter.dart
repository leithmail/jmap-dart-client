...
class CalendarAttendeeRoleNullableConverter
    implements JsonConverter<CalendarAttendeeRole?, String?> {
  const CalendarAttendeeRoleNullableConverter();

  @override
  CalendarAttendeeRole? fromJson(String? json) =>
      json != null ? CalendarAttendeeRole(json) : null;
