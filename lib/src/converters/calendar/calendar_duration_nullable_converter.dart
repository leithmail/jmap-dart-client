...
class CalendarDurationNullableConverter
    implements JsonConverter<CalendarDuration?, String?> {
  const CalendarDurationNullableConverter();

  @override
  CalendarDuration? fromJson(String? json) =>
      json != null ? CalendarDuration(json) : null;
